...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post polls_url, params: { poll: { category_id: @poll.category_id, poll_text: @poll.poll_text } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { category_id: @poll.category_id, poll_text: @poll.poll_text } }
