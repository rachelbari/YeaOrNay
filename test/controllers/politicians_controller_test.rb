...
class PoliticiansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create politician" do
    assert_difference('Politician.count') do
      post politicians_url, params: { politician: { first_name: @politician.first_name, last_name: @politician.last_name, party: @politician.party, role: @politician.role, state: @politician.state } }
    end
  ...
  test "should update politician" do
    patch politician_url(@politician), params: { politician: { first_name: @politician.first_name, last_name: @politician.last_name, party: @politician.party, role: @politician.role, state: @politician.state } }
